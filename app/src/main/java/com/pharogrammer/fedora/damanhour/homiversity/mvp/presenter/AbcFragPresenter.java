...
public class AbcFragPresenter implements FragmentMVP.AbcPresenter {

    FragmentMVP.AbcView view;
    FragmentMVP.AbcModel model;
    Subscription subscription;

    public AbcFragPresenter(FragmentMVP.AbcModel model) {
        this.model = model;
    }

    @Override
    public void setView(FragmentMVP.AbcView view) {
        this.view = view;
    }
