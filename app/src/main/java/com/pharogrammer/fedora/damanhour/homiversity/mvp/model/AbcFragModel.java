...
public class AbcFragModel implements FragmentMVP.AbcModel {


    Repository third2Repo;

    public AbcFragModel(Repository third2Repo) {
    ...
    public Observable<Lecture> getCeuticalTheoLectures() {
        return third2Repo.getAvailableCeuticalLectures().filter(new Func1<Lecture, Boolean>() {
            ...
            public Boolean call(Lecture lecture) {
                return  lecture.getTeam().equals(Constants.TEAM_ABC)
